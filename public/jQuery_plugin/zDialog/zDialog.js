 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/jQuery_plugin/zDialog/images/'; //图片路径配置
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#ccc;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
